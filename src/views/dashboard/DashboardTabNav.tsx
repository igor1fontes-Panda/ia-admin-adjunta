...
export type DashboardTab =
  "overview" | "packs" | "leads" | "charts" | "clients" | "orders" | "agents" | "ecosystem" | "godseye";
...
export function DashboardTabNav({
  ...
  return (
    <nav
      aria-label={typeof menuLabel === "string" ? menuLabel : "Modules"}
      className="mt-8 flex gap-1 overflow-x-auto rounded-2xl border border-white/10 bg-ink-900/80 p-1"
    >
      {tabs.map((value) => {
